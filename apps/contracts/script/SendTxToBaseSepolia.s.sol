...
contract SendTxToBaseSepolia is Script {
    ...
    address constant DAOLEAKS_CONTRACT = 0x65cC4D5f790dF736cD54d675d9280c056d640b22; // UPDATE THIS
    ...
    function run() public {
        ...
        bytes memory proof = vm.envBytes("HONK_PROOF"); // Replace with actual proof
        string memory message = "Signed by Alice";
        uint8 votingPowerLevel = 0; // 0 = 1,000 tokens, 1 = 10,000 tokens, 2 = 50,000 tokens
        ...
        daoLeaks.addStorageRoot(storageRoot, block.number, block.timestamp);
